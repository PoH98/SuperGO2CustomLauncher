...
namespace GO2FlashLauncher.Service
{
    internal class GO2HttpService
    {
        ...
        public GO2HttpService()
        {
            ...
            httpClient.DefaultRequestHeaders.TryAddWithoutValidation("origin", "https://beta.supergo2.com");
            httpClient.DefaultRequestHeaders.TryAddWithoutValidation("referer", "https://beta.supergo2.com");
        ...
        {
            var response = await httpClient.PostAsync("https://beta-api.supergo2.com/login/login/account", new StringContent(JsonConvert.SerializeObject(new
            {
                username,
                password
        ...
        {
            var response = await httpClient.GetAsync("https://beta-api.supergo2.com/account/play/user/" + id);
        ...
        {
            var response = await httpClient.GetAsync("https://beta-api.supergo2.com/account/list/user");
